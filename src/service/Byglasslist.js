...
export default class Byglasslist extends Component {
    ...
    constructor(props) {
        ...
        this.filterCount = dm.byGlassDataLength;
        ...
        this.props.navigation.setParams({
            filterCount: dm.byGlassDataLength,
            });
    }
    ...
    setDataType = () => {
        this.dataChampagne = dm.filterDataTypeForView('byglass', 'CHAMPAGNE');
        this.dataRed = dm.filterDataTypeForView('byglass', 'RED');
        this.dataWhite = dm.filterDataTypeForView('byglass', 'WHITE');
        this.dataRose = dm.filterDataTypeForView('byglass', 'ROSE');
       this.dataSweet = dm.filterDataTypeForView('byglass', 'SWEET'); 
        ...
        headerRight:
         <View style={{flexDirection: 'row' , alignItems:"center",flexDirection: 'row',justifyContent: 'space-between', top:-10}}>
            <View style={{backgroundColor:'#c3c3c4',marginRight:35,padding:2,flexDirection: 'row',justifyContent: 'space-between'}}>
                    ...
                    >
                        <Text style={{fontWeight: "bold", color:'#fff',textAlign: 'center', fontSize: 22}}>{navigation.getParam('filterCount') == null ? dm.byGlassDataLength : navigation.getParam('filterCount')}</Text>
                        </View>
                    </View>
                    </TouchableOpacity>
            </View>
          ...
          this.state.statusC ? <View>
                ...
                <View style={styles.container}>
                    <View style={{marginTop:10,flexDirection: 'row',justifyContent: 'space-between'}}>
                        ...
                        <View style={{marginBottom:10, marginLeft:10,color:'#ee4723'}}>
                            <View style={{paddingBottom: 8}}>
