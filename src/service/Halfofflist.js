...
export default class Halfofflist extends Component {
    ...
    constructor(props) {
        ...
        this.filterCount = dm.halfOffDataLength;
        ...
        this.props.navigation.setParams({
            filterCount: dm.halfOffDataLength,
            });
    ...
    setDataType = () => {
        this.dataChampagne = dm.filterDataTypeForView('promotion', 'CHAMPAGNE');
        this.dataRed = dm.filterDataTypeForView('promotion', 'RED');
        this.dataWhite = dm.filterDataTypeForView('promotion', 'WHITE');
        this.dataRose = dm.filterDataTypeForView('promotion', 'ROSE');
        this.dataSweet = dm.filterDataTypeForView('promotion', 'SWEET');      
    }
        ...
        headerRight:
         <View style={{flexDirection: 'row' , alignItems:"center",flexDirection: 'row',justifyContent: 'space-between', top:-10}}>
            <View style={{backgroundColor:'#c3c3c4',marginRight:35,padding:2,flexDirection: 'row',justifyContent: 'space-between'}}>
                    ...
                    >
                        <Text style={{fontWeight: "bold", color:'#fff',textAlign: 'center', fontSize: 22}}>{navigation.getParam('filterCount') == null ? dm.halfOffDataLength : navigation.getParam('filterCount')}</Text>
                        </View>
                    </View>
                    </TouchableOpacity>
            </View>
                ...
                <View style={styles.container}>
                    <View style={{marginTop:10,flexDirection: 'row',justifyContent: 'space-between'}}>
                        ...
                        { dm.countryNamesIn('RED').map((country, i) => {
                            return       <TouchableOpacity key={i} onPress = {() => this.props.navigation.navigate('Fullwinelist', this.scrollViewRef.scrollTo({x: 0,
                    ...
                    <View style={{marginLeft: 10,marginBottom:10, marginTop:20, marginRight: 10}} onLayout =
                    ...
                    <View style={{marginLeft: 10,marginBottom:10, marginTop:20, marginRight: 10}}
