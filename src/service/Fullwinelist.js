...
export default class Fullwinelist extends Component {
    ...
    constructor(props) {
        ...
        this.filterCount = dm.fullDataLength;
    ...
    setDataType = () => {
        this.dataChampagne = dm.data['CHAMPAGNE'];
        this.dataRed = dm.data['RED'];
         this.dataWhite = dm.data['WHITE'];
        this.dataRose = dm.data['ROSE'];
       this.dataSweet = dm.data['SWEET'];       
    }
        ...
        headerRight:
         <View style={{flexDirection: 'row' , alignItems:"center",flexDirection: 'row',justifyContent: 'space-between', top:-10}}>
            <View style={{backgroundColor:'#c3c3c4',marginRight:35,padding:2,flexDirection: 'row',justifyContent: 'space-between'}}>
                    ...
                    >
                        <Text style={{fontWeight: "bold", color:'#fff',textAlign: 'center', fontSize: 22}}>{navigation.getParam('filterCount') == null ? dm.fullDataLength : navigation.getParam('filterCount')}</Text>
                        </View>
                    </View>
                    </TouchableOpacity>
            </View>
          ...
          this.state.statusC ? <View>
                ...
                <View style={styles.container}>
                    ...
                    {dm.countryNamesIn('CHAMPAGNE').map((item, i) => {
                        ...
                        style={{flex:1}}> </Wineflatlist>
                    })}

                    </View>

                    <View style={{marginLeft: 10,marginBottom:10, marginTop:30, marginRight: 10}} 
                                    onLayout ={(e) => this.recordLayout('RED','parent',e.nativeEvent.layout.y)}
                    >
                        <Text style={{color:'#fff',fontSize: 46,fontFamily:"American Typewriter"}}>
                            RED
                        </Text>
