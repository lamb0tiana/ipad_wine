                    ...
                    <View style={styles.row}>
                        <View style={styles.first}>
                            <View style={styles.firstButton}>
                                <ImageBackground source={require('../img/icon1.png')} style={{ height: 1.08*wp('40,38%'),marginTop: 5,paddingTop: 1}}>
                        ...
                        <View style={styles.second}>
                            <View style={styles.thirdButton}>
                                <ImageBackground source={require('../img/icon3.png')} style={{ height: 1.08*wp('40,38%'), marginTop: 5,paddingTop: 1}}>
                            ...
                            <View style={styles.fourthButton}>
                                <ImageBackground source={require('../img/icon4.png')} style={{ height: 1.08*wp('40,38%'),marginTop: 5,paddingTop: 1}}>
